...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="row" style="height:400px; ">
      <div class="container" style="margin-top:20px;">
          <div class="row" id="shake">
              <div class="col-lg-4 effect2">
                <img class="img-circle" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" alt="Generic placeholder image" width="140" height="140">
                <h2>Web animations</h2>
                <p>Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna.</p>
                <p><a class="btn btn-default" href="javascript:runEffect('shake','shake');" role="button">View details »</a></p>
              </div><!-- /.col-lg-4 -->
              <div class="col-lg-4 effect3">
                <img class="img-circle" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" alt="Generic placeholder image" width="140" height="140">
                <h2>Web animations</h2>
       ...
       <div class="container">
           <div class="row" id="effect">
               <div class="col-md-4">
                 ...
                 <p><a class="btn btn-default" href="javascript:runEffect('explode','effect');" role="button">Click to view effect »</a></p>
               </div>
               <div class="col-md-4">
                 <h2>jQuery Ui</h2>
                 <p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. </p>
  ...
  <script>
    ...
    var tween = TweenMax.fromTo("#animate1", 1,
                  {left: -0},
                  {left: $(window).width() - 300, repeat: -1, yoyo: true, ease: Circ.easeInOut, delay: 0, repeatDelay: 2 }
                );
